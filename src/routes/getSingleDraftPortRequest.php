<?php
$app->post('/api/Telnyx/getSingleDraftPortRequest', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'origination/porting/draft_port_requests/'.$post_data['args']['draftPortRequestId'];
    $params = [
